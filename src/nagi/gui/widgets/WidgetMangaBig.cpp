...
#include "WidgetMangaBig.hpp"

namespace Nagi {
    WidgetMangaBig::WidgetMangaBig(BaseObjectType *cobject, const Glib::RefPtr<Gtk::Builder> &refBuilder)
            : Gtk::Button(cobject),
              m_refBuilder(refBuilder) {

    }

    WidgetMangaBig *WidgetMangaBig::create(
            Glib::ustring title,
            Glib::ustring aired,
        ...
        WidgetMangaBig *widgetMangaBig = nullptr;
        refBuilder->get_widget_derived("buttonAnimeBig", widgetMangaBig);
        if (widgetMangaBig == nullptr)
